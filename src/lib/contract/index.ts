export function editContract(data: string) {
  return `
    ...
    contract ReadyPlayerMePunks is ERC721, ERC721URIStorage, ERC721Enumerable
    {
        ...
        function _mintSingle(ERC721 _parentContract, uint _parentIndex) private
        {
            require(_parentContract.ownerOf(_parentIndex) == msg.sender, "Parent token owner and sender mismatch.");
